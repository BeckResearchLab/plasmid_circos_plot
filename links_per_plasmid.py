...
print("writing to 'links_per_plasmid.txt'")
links_per_plasmid = df[['qseqid', 'qstart', 'qend', 'sseqid', 'sstart', 'send', 'color']]
links_per_plasmid.to_csv("links_per_plasmid.txt", sep='\t', quoting=csv.QUOTE_NONE, header=False, index=False)
